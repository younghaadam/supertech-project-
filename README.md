...
# 📖 [Supertech Project] <a name="contact-project"></a>
...
- GitHub: [@githubhandle](https://github.com/Highzik)
...
Feel free to check the [issues page](https://github.com/Highzik/hello-rails-react/issues/).
